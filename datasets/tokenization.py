...
class BasicTokenizer(object):
    ...
    Args:
      ...
      split_on_punc: Whether to apply split on punctuations. By default BERT
        starts a new token for punctuations. This makes detokenization
        difficult for tasks like seq2seq decoding.
    """
    ...
    def tokenize(self, text):
        ...
        # models. This is also applied to the English models now, but itdoesn't
    ...
    def _is_chinese_char(self, cp):
        ...
        # characters,
        # despite its name. The modern Korean Hangul alphabet is a different
        # block,
...
def preprocess_text(inputs, remove_space=True, lower=False):
  ...
  This method is used together with sentence piece tokenizer and is forked
  from:
